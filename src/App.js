  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        Todays Meat: {state.reducerMeat.numOfMeat}
        <button onClick={()=>dispatch({type: SELL_VEGETABLE})}>Sell vegrtable</button>
        Todays Vegetable: {state.reducerVegetable.numOfVegetable}
      </header>
    </div>
  );
}
